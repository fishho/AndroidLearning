...
public class BadgeDemoActivity extends TabActivity {

    private static final String[] DATA = Chesses.sCheeseStrings;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btnAnim2.setBackgroundResource(android.R.color.transparent);
        ...
        badge6.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(BadgeDemoActivity.this, "clicked badge", Toast.LENGTH_SHORT).show();
            }
        });
