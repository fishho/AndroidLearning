...
/**
 * Created by GKX100217 on 2016/6/24.
 */
public class FloatingActionButton extends ImageButton {
    ...
    private Drawable createCircleDrawable(int color, float strokeWidth) {
        ...
        int halfSrokeWidth = (int)(strokeWidth/2f);
        drawable.setLayerInset(1, halfSrokeWidth, halfSrokeWidth,halfSrokeWidth, halfSrokeWidth);
        return drawable;
    }
